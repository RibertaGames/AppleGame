...
namespace RibertaGames
{
	...
	public static class ConstantsClassCreator
	{
		...
		public static void Create<T>(string className, string summary, Dictionary<string, T> valueDict, string exportDirectoryPath, string nameSpace = "")
		{
			...
			{
				string newKey = _RemoveInvalidChars(valuePair.Key);
				newKey = _SetDelimiterBeforeUppercase(newKey);
		...
		/// 無効な文字を削除します
		/// </summary>
		private static string _RemoveInvalidChars(string str)
		{
		...
		/// 区切り文字を大文字の前に設定する
		/// </summary>
		private static string _SetDelimiterBeforeUppercase(string str)
		{
