...
namespace Crystal
{
    ...
    public class SafeArea : MonoBehaviour
    {
        ...
        /// </summary>
        public static eSimDevice sim = eSimDevice.None;
        ...
        ///  Aspect Ratio: ~19.5:9.
        /// </summary>
        private Rect[] _nSA_iPhoneX = new Rect[]
        {
        ...
        ///  Aspect Ratio: ~19.5:9.
        /// </summary>
        private Rect[] _nSA_iPhoneXsMax = new Rect[]
        {
        ...
        ///  Aspect Ratio: 18.5:9.
        /// </summary>
        private Rect[] _nSA_Pixel3XL_LSL = new Rect[]
        {
        ...
        /// </summary>
        private Rect[] _nSA_Pixel3XL_LSR = new Rect[]
        {
            new Rect (0f, 0f, 1f, 2789f / 2960f),  // Portrait
        ...
        private void _Refresh()
        {
                ...
                || Screen.orientation != _lastOrientation)
            {
                ...
                _ApplySafeArea(safeArea);
            }
        }

        private Rect _GetSafeArea()
        {
            Rect safeArea = Screen.safeArea;

            if (Application.isEditor && sim != eSimDevice.None)
            {
                Rect nsa = new Rect(0, 0, Screen.width, Screen.height);

                switch (sim)
                {
                    case eSimDevice.iPhoneX:
                        if (Screen.height > Screen.width)  // Portrait
                            nsa = _nSA_iPhoneX[0];
                        else  // Landscape
                            nsa = _nSA_iPhoneX[1];
                        break;
                    case eSimDevice.iPhoneXsMax:
                        if (Screen.height > Screen.width)  // Portrait
                            nsa = _nSA_iPhoneXsMax[0];
                        else  // Landscape
                            nsa = _nSA_iPhoneXsMax[1];
                        break;
                    case eSimDevice.Pixel3XL_LSL:
                        if (Screen.height > Screen.width)  // Portrait
                            nsa = _nSA_Pixel3XL_LSL[0];
                        else  // Landscape
                            nsa = _nSA_Pixel3XL_LSL[1];
                        break;
                    case eSimDevice.Pixel3XL_LSR:
                        if (Screen.height > Screen.width)  // Portrait
                            nsa = _nSA_Pixel3XL_LSR[0];
                        else  // Landscape
                            nsa = _nSA_Pixel3XL_LSR[1];
                        break;
                    default:
                        break;
                }
        ...
        private void _ApplySafeArea(Rect r)
        {
            _lastSafeArea = r;
